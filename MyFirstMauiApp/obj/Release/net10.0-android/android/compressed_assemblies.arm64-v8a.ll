...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [198 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2306048, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 22458504; uint32_t buffer_offset
	}, ; 195: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 22630536; uint32_t buffer_offset
	}, ; 196: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2128896, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 22653096; uint32_t buffer_offset
	} ; 197: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 24781992, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [24781992 x i8] zeroinitializer, align 1
