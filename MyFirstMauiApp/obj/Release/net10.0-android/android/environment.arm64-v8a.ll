...
@dso_apk_entries = dso_local local_unnamed_addr global [172 x %struct.DSOApkEntry] zeroinitializer, align 8
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [29 x i8] c"libaot-SmartScheduler.dll.so\00", align 1
@.DSOCacheEntry.10_name = private unnamed_addr constant [36 x i8] c"libaot-CommunityToolkit.Mvvm.dll.so\00", align 1
@.DSOCacheEntry.11_name = private unnamed_addr constant [28 x i8] c"libaot-Firebase.Auth.dll.so\00", align 1
...
@.DSOCacheEntry.19_name = private unnamed_addr constant [38 x i8] c"libaot-Google.Apis.Calendar.v3.dll.so\00", align 1
@.DSOCacheEntry.20_name = private unnamed_addr constant [31 x i8] c"libaot-Google.Apis.Core.dll.so\00", align 1
@.DSOCacheEntry.21_name = private unnamed_addr constant [37 x i8] c"libaot-Google.Cloud.Firestore.dll.so\00", align 1
@.DSOCacheEntry.22_name = private unnamed_addr constant [40 x i8] c"libaot-Google.Cloud.Firestore.V1.dll.so\00", align 1
@.DSOCacheEntry.23_name = private unnamed_addr constant [36 x i8] c"libaot-Google.Cloud.Location.dll.so\00", align 1
@.DSOCacheEntry.24_name = private unnamed_addr constant [33 x i8] c"libaot-Google.LongRunning.dll.so\00", align 1
@.DSOCacheEntry.25_name = private unnamed_addr constant [30 x i8] c"libaot-Google.Protobuf.dll.so\00", align 1
@.DSOCacheEntry.26_name = private unnamed_addr constant [24 x i8] c"libaot-Grpc.Auth.dll.so\00", align 1
@.DSOCacheEntry.27_name = private unnamed_addr constant [28 x i8] c"libaot-Grpc.Core.Api.dll.so\00", align 1
@.DSOCacheEntry.28_name = private unnamed_addr constant [30 x i8] c"libaot-Grpc.Net.Client.dll.so\00", align 1
@.DSOCacheEntry.29_name = private unnamed_addr constant [30 x i8] c"libaot-Grpc.Net.Common.dll.so\00", align 1
...
@.DSOCacheEntry.36_name = private unnamed_addr constant [60 x i8] c"libaot-Microsoft.Extensions.Diagnostics.Abstractions.dll.so\00", align 1
...
@.DSOCacheEntry.38_name = private unnamed_addr constant [56 x i8] c"libaot-Microsoft.Extensions.Hosting.Abstractions.dll.so\00", align 1
@.DSOCacheEntry.39_name = private unnamed_addr constant [43 x i8] c"libaot-Microsoft.Extensions.Logging.dll.so\00", align 1
@.DSOCacheEntry.40_name = private unnamed_addr constant [56 x i8] c"libaot-Microsoft.Extensions.Logging.Abstractions.dll.so\00", align 1
...
@.DSOCacheEntry.51_name = private unnamed_addr constant [39 x i8] c"libaot-Plugin.LocalNotification.dll.so\00", align 1
@.DSOCacheEntry.52_name = private unnamed_addr constant [25 x i8] c"libaot-SQLite-net.dll.so\00", align 1
@.DSOCacheEntry.53_name = private unnamed_addr constant [40 x i8] c"libaot-SQLitePCLRaw.batteries_v2.dll.so\00", align 1
@.DSOCacheEntry.54_name = private unnamed_addr constant [32 x i8] c"libaot-SQLitePCLRaw.core.dll.so\00", align 1
@.DSOCacheEntry.55_name = private unnamed_addr constant [49 x i8] c"libaot-SQLitePCLRaw.lib.e_sqlite3.android.dll.so\00", align 1
@.DSOCacheEntry.56_name = private unnamed_addr constant [46 x i8] c"libaot-SQLitePCLRaw.provider.e_sqlite3.dll.so\00", align 1
@.DSOCacheEntry.57_name = private unnamed_addr constant [29 x i8] c"libaot-System.CodeDom.dll.so\00", align 1
@.DSOCacheEntry.58_name = private unnamed_addr constant [32 x i8] c"libaot-System.Management.dll.so\00", align 1
@.DSOCacheEntry.59_name = private unnamed_addr constant [30 x i8] c"libaot-System.Reactive.dll.so\00", align 1
...
@.DSOCacheEntry.74_name = private unnamed_addr constant [69 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.ViewModelSavedState.Android.dll.so\00", align 1
@.DSOCacheEntry.75_name = private unnamed_addr constant [38 x i8] c"libaot-Xamarin.AndroidX.Loader.dll.so\00", align 1
@.DSOCacheEntry.76_name = private unnamed_addr constant [57 x i8] c"libaot-Xamarin.AndroidX.Navigation.Common.Android.dll.so\00", align 1
...
@.DSOCacheEntry.78_name = private unnamed_addr constant [58 x i8] c"libaot-Xamarin.AndroidX.Navigation.Runtime.Android.dll.so\00", align 1
...
@.DSOCacheEntry.87_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Base.dll.so\00", align 1
@.DSOCacheEntry.88_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Basement.dll.so\00", align 1
@.DSOCacheEntry.89_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Location.dll.so\00", align 1
@.DSOCacheEntry.90_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Maps.dll.so\00", align 1
...
@.DSOCacheEntry.107_name = private unnamed_addr constant [39 x i8] c"libaot-System.Diagnostics.Debug.dll.so\00", align 1
...
@.DSOCacheEntry.118_name = private unnamed_addr constant [24 x i8] c"libaot-System.IO.dll.so\00", align 1
@.DSOCacheEntry.119_name = private unnamed_addr constant [42 x i8] c"libaot-System.Linq.AsyncEnumerable.dll.so\00", align 1
...
@.DSOCacheEntry.124_name = private unnamed_addr constant [38 x i8] c"libaot-System.Net.HttpListener.dll.so\00", align 1
@.DSOCacheEntry.125_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 1
...
@.DSOCacheEntry.141_name = private unnamed_addr constant [40 x i8] c"libaot-System.Runtime.Extensions.dll.so\00", align 1
...
@.DSOCacheEntry.149_name = private unnamed_addr constant [37 x i8] c"libaot-System.Security.Claims.dll.so\00", align 1
@.DSOCacheEntry.150_name = private unnamed_addr constant [54 x i8] c"libaot-System.Security.Cryptography.Algorithms.dll.so\00", align 1
...
@.DSOCacheEntry.154_name = private unnamed_addr constant [46 x i8] c"libaot-System.Text.Encoding.Extensions.dll.so\00", align 1
@.DSOCacheEntry.155_name = private unnamed_addr constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 1
@.DSOCacheEntry.156_name = private unnamed_addr constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 1
@.DSOCacheEntry.157_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.RegularExpressions.dll.so\00", align 1
@.DSOCacheEntry.158_name = private unnamed_addr constant [40 x i8] c"libaot-System.Threading.Channels.dll.so\00", align 1
@.DSOCacheEntry.159_name = private unnamed_addr constant [48 x i8] c"libaot-System.Threading.Tasks.Extensions.dll.so\00", align 1
@.DSOCacheEntry.160_name = private unnamed_addr constant [37 x i8] c"libaot-System.Threading.Tasks.dll.so\00", align 1
@.DSOCacheEntry.161_name = private unnamed_addr constant [38 x i8] c"libaot-System.Threading.Thread.dll.so\00", align 1
@.DSOCacheEntry.162_name = private unnamed_addr constant [31 x i8] c"libaot-System.Threading.dll.so\00", align 1
@.DSOCacheEntry.163_name = private unnamed_addr constant [30 x i8] c"libaot-System.Xml.Linq.dll.so\00", align 1
@.DSOCacheEntry.164_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 1
@.DSOCacheEntry.165_name = private unnamed_addr constant [35 x i8] c"libaot-System.Xml.XDocument.dll.so\00", align 1
